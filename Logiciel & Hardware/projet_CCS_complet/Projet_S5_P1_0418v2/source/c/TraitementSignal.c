...
float SeuilDetect = 0.95; //pour bole à fondue
//float SeuilDetect = 0.9; //pour bole à soupe
float ResCorr = 16;
...
void initTraitementSignal(){
    ...
    {
        TabCorr0[k] = TabSmooth[k * DECIMATION];
        TabCorr1[k] = 0;
        TabCorr2[k] = 0;
        TabCorr3[k] = 0;
        TabCorr4[k] = 0;
